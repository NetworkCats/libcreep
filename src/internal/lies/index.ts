...
function queryLies({
	...
	if (detectProxies) {
		...
		// `proxy2++` exercises recursive coercion below. `let` preserves that
		// runtime probe while remaining valid for strict static bundlers.
		let proxy2 = new Proxy(apiFunction, {})
